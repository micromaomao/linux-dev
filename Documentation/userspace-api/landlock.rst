...
Starting with ABI version 11, Landlock supports supervisor rulesets, which
...
Supervisor rulesets (ABI < 11)
-----------------------------

Starting with the Landlock ABI version 11, it is possible to create supervisor
