...
struct v9fs_ino_path {
	struct v9fs_ino_path *parent;
	struct name_snapshot name;
	refcount_t usage;
};

extern int v9fs_init_ino_path_cache(void);
extern struct v9fs_ino_path *make_ino_path(struct dentry *dentry);
extern void get_ino_path(struct v9fs_ino_path *inopath);
extern void put_ino_path(struct v9fs_ino_path *inopath);
extern bool ino_path_compare(struct v9fs_ino_path *inopath,
			     struct dentry *dentry);
extern void ino_path_rename(struct v9fs_ino_path *src, struct dentry *dst_name);
