...
{
	fprintf(stderr,
		"Usage: %s <config_file> <denials_log_file> <command> [args...]\n"
		"\n"
		...
		"and immediately denies the request with -EPERM.\n"
		"\n"
	...
	while (!child_exited) {
		...
		if (pfds[1].revents & POLLIN) {
			...
			if (len > 0) {
				...
				/* Immediately deny the request with -EPERM */
				{
