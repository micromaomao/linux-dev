 ...
 * - %LANDLOCK_SCOPE_PATHNAME_SOCKET: Restrict a sandboxed process from
 *   connecting to a pathname (filesystem path) UNIX socket created by a process
...
#define LANDLOCK_SCOPE_PATHNAME_SOCKET			(1ULL << 2)
/* clang-format on*/
