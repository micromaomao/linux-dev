 ...
 * - %LANDLOCK_SCOPE_NAMED_UNIX_SOCKET: Restrict a sandboxed process from
 *   connecting to a named (filesystem path) UNIX socket created by a process
...
#define LANDLOCK_SCOPE_NAMED_UNIX_SOCKET		(1ULL << 2)
/* clang-format on*/
